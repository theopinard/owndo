...
mixin _$Subtask {
 ...
 String get id; String get taskId; String get title; int get currentStep; int get createdAt; int get updatedAt; bool get deleted;
...
@override
int get hashCode => Object.hash(runtimeType,id,taskId,title,currentStep,createdAt,updatedAt,deleted);
...
@useResult
$Res call({
 String id, String taskId, String title, int currentStep, int createdAt, int updatedAt, bool deleted
});
...
/// Create a copy of Subtask
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? taskId = null,Object? title = null,Object? currentStep = null,Object? createdAt = null,Object? updatedAt = null,Object? deleted = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String taskId,  String title,  int currentStep,  int createdAt,  int updatedAt,  bool deleted)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Subtask() when $default != null:
return $default(_that.id,_that.taskId,_that.title,_that.currentStep,_that.createdAt,_that.updatedAt,_that.deleted);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String taskId,  String title,  int currentStep,  int createdAt,  int updatedAt,  bool deleted)  $default,) {final _that = this;
switch (_that) {
case _Subtask():
return $default(_that.id,_that.taskId,_that.title,_that.currentStep,_that.createdAt,_that.updatedAt,_that.deleted);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String taskId,  String title,  int currentStep,  int createdAt,  int updatedAt,  bool deleted)?  $default,) {final _that = this;
switch (_that) {
case _Subtask() when $default != null:
return $default(_that.id,_that.taskId,_that.title,_that.currentStep,_that.createdAt,_that.updatedAt,_that.deleted);case _:
  return null;
...
class _Subtask extends Subtask {
  const _Subtask({required this.id, required this.taskId, required this.title, this.currentStep = 0, required this.createdAt, required this.updatedAt, required this.deleted}): super._();
...
/// Create a copy of Subtask
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? taskId = null,Object? title = null,Object? currentStep = null,Object? createdAt = null,Object? updatedAt = null,Object? deleted = null,}) {
