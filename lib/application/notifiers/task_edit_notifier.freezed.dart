...
mixin _$TaskEditState {
 ...
 String get title; String? get description; String? get projectId; bool get isNew; String? get existingTaskId; int? get deadline; int? get reminderAt; int get subtaskSteps;
...
@useResult
$Res call({
 String title, String? description, String? projectId, bool isNew, String? existingTaskId, int? deadline, int? reminderAt, int subtaskSteps
});
...
/// Create a copy of TaskEditState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? title = null,Object? description = freezed,Object? projectId = freezed,Object? isNew = null,Object? existingTaskId = freezed,Object? deadline = freezed,Object? reminderAt = freezed,Object? subtaskSteps = null,}) {
...
as bool,existingTaskId: freezed == existingTaskId ? _self.existingTaskId : existingTaskId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String title,  String? description,  String? projectId,  bool isNew,  String? existingTaskId,  int? deadline,  int? reminderAt,  int subtaskSteps)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TaskEditState() when $default != null:
return $default(_that.title,_that.description,_that.projectId,_that.isNew,_that.existingTaskId,_that.deadline,_that.reminderAt,_that.subtaskSteps);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String title,  String? description,  String? projectId,  bool isNew,  String? existingTaskId,  int? deadline,  int? reminderAt,  int subtaskSteps)  $default,) {final _that = this;
switch (_that) {
case _TaskEditState():
return $default(_that.title,_that.description,_that.projectId,_that.isNew,_that.existingTaskId,_that.deadline,_that.reminderAt,_that.subtaskSteps);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String title,  String? description,  String? projectId,  bool isNew,  String? existingTaskId,  int? deadline,  int? reminderAt,  int subtaskSteps)?  $default,) {final _that = this;
switch (_that) {
case _TaskEditState() when $default != null:
return $default(_that.title,_that.description,_that.projectId,_that.isNew,_that.existingTaskId,_that.deadline,_that.reminderAt,_that.subtaskSteps);case _:
  return null;
...
class _TaskEditState implements TaskEditState {
  const _TaskEditState({required this.title, this.description, this.projectId, required this.isNew, this.existingTaskId, this.deadline, this.reminderAt, this.subtaskSteps = 1});
...
@override final  String? existingTaskId;
...
/// Create a copy of TaskEditState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? title = null,Object? description = freezed,Object? projectId = freezed,Object? isNew = null,Object? existingTaskId = freezed,Object? deadline = freezed,Object? reminderAt = freezed,Object? subtaskSteps = null,}) {
